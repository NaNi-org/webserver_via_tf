...
variable "ingress_with_external_security_group_id" {
  description = "List of ingress rules to create where 'external_security_group_id' is used"
  type        = list(map(string))
  default     = []
}

variable "egress_with_external_security_group_id" {
  description = "List of ingress rules to create where 'external_security_group_id' is used"
  type        = list(map(string))
  default     = []
}
